...
const TWITTER_KEYS = [
 ...
 const checkFollowings =  async (req, res) => {
 ...
 const getFollowedBack = async (req, res) => {
 ...
 const gainFollowers = async (req, res) => {
    const random = TWITTER_KEYS[0];
            ...
            const check = setInterval(() => {
                ...
                if (userArr.length === lastHourTweets.length) {
                    ...
                    setTimeout(async () => {
                        ...
                        //   console.log(el);
                        // })
                        await followUsersasync (req, res, userArr, client);
                    }, 5000);
                }
            }, 1000);
        } else {
 ...
 const followUsers = async (req, res, userArray, client) => {
    var users = [];
    var userz = [];
